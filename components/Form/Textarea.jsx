  ...
  return (
    <div className="relative my-4">
      <textarea
        ...
        value={value}
        onChange={onChange}
        className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-gray-300 appearance-none border-2 focus:outline-none focus:ring-0 focus:border-swift-purple-700 peer dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700 text-justify"
        placeholder=" "
        rows="4"
      />
      <label
